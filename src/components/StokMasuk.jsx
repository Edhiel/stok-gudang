...
const FormPenerimaan = ({ receiptId, setView, userProfile, setPrintableData }) => {
    ...
    const handleAddItem = (item) => {
        ...
        setDosQty(0); setPackQty(0); setPcsQty(0); setSelectedLocation(''); setExpireDate('');
    };
    ...
    const handleAddBonusItem = (item, catatan) => {
        ...
        setSearchTerm(''); setSelectedItem(null);
        setDosQty(0); setPackQty(0); setPcsQty(0); setBonusCatatan(''); setSelectedLocation(''); setExpireDate('');
    };
        ...
        try {
            ...
            await push(transactionsRef, {
                ...
                items: finalFisikData.map(item => ({ 
                    ...
                    expireDate: item.expireDate, locationId: item.locationId
                })),
