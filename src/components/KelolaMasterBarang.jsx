...
function KelolaMasterBarang() {
  ...
  // PENINGKATAN: Debouncing pada pencarian
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error("Gagal menambahkan barang: " + err.message); 
    } finally {
  ...
  const handleUpdateItem = async () => {
    ...
    try {
      ...
      toast.error("Gagal memperbarui barang: " + err.message);
    } finally {
      setIsSubmitting(false);
    }
  };
          ...
          <form onSubmit={handleSubmit} className="card bg-white shadow-lg p-6 space-y-2">
            ...
            <div className="form-control mt-4">
                <button type="submit" className="btn btn-primary" disabled={isSubmitting}>
                    {isSubmitting ? <span className="loading loading-spinner"></span> : 'Simpan ke Master'}
                </button>
            </div>
          </form>
        </div>
          ...
          <div className="card bg-white shadow-lg p-4 mb-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" placeholder="Ketik untuk mencari..." className="input input-bordered w-full" onChange={e => setSearchTerm(e.target.value)} />
                </div>
        ...
        <div className="modal modal-open">
          <div className="modal-box w-11/2 max-w-2xl">
            ...
            <div className="modal-action">
              <button onClick={handleUpdateItem} className="btn btn-primary" disabled={isSubmitting}>
