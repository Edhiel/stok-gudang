...
function UserProfile({ userProfile }) {
  ...
  if (!userProfile) {
    return <div className="p-8 text-center"><span className="loading loading-dots"></span></div>;
  }
      ...
      <div className="card bg-white shadow-lg">
        <div className="card-body">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div><label className="font-bold">Email:</label><p>{userProfile.email}</p></div>
            <div><label className="font-bold">Role:</label><p>{userProfile.role}</p></div>
            <div><label className="font-bold">Depo:</label><p>{userProfile.depotId}</p></div>
          </div>
          <form onSubmit={handleUpdateName} className="mt-4">
            ...
            <div className="form-control mt-4">
              <button type="submit" className="btn btn-primary">Simpan Nama</button>
            </div>
          </form>
        </div>
      </div>
        ...
        <div className="card-body">
          ...
          <form onSubmit={handleUpdatePassword} className="space-y-4 mt-4">
            <div className="form-control">
              ...
              <input type="password" value={newPassword} onChange={e => setNewPassword(e.target.value)} className="input input-bordered" />
            </div>
            <div className="form-control">
            ...
            <div className="form-control mt-4">
              <button type="submit" className="btn btn-secondary">Ubah Password</button>
            </div>
          </form>
        </div>
      </div>
