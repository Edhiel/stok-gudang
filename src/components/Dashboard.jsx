...
// --- PALET WARNA BARU (KODE HEX) ---
const colorSchemes = {
  orderan: '#0891B2',      // Cyan 600
  operasional: '#2563EB',  // Blue 600
  master: '#16A34A',       // Green 600
  admin: '#9333EA',        // Purple 600
  laporan: '#D97706',       // Amber 600
};

// --- OBJEK IKON LENGKAP (SUDAH DIPERBARUI) ---
const Ikon = {
